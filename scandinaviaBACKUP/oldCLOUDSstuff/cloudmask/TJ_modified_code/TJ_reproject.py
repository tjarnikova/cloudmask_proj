...
def reproj_L1B(raw_x, raw_y, xlim, ylim, res):
    ...
    # print(x_indices.shape[0])
    y_indices=np.searchsorted(y_bins, np.ravel(raw_y), 'right')
    # print(x_indices[0])
    # print(y_indices[0])    
    # print(raw_x.flat[0])
    # print(raw_y.flat[0])
    ...
    return x_array, y_array, bin_count
...
#     return  x_bins, x_indices #array, y_array, bin_count
