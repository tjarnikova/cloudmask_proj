...
geom_file,=glob.glob('./scandinavia/MYD03*h5')
...
CBar=proj.colorbar(CS, 'right', size='5%', pad='5%',extend='both')
CBar.set_label('6.7 micron brightness temp (K)')
proj.ax.set_title('6.7 micron brightness temp')
proj.ax.figure.canvas.draw()
fig.savefig('c29_bright.png')
...
CBar=proj.colorbar(CS, 'right', size='5%', pad='5%',extend='both')
CBar.set_label('diff btwn 11 and 6.7 micron brightness temp (K)')
proj.ax.set_title('11 and 6.7 brightness temp difference')
proj.ax.figure.canvas.draw()
fig.savefig('diffbright.png')
