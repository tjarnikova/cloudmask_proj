...
ch32bright_grid, longrid, latgrid, bin_count = reproj_L1B(ch32_bright, missing_val, small_lons, small_lats, lonlim, latlim, res)
...
fig.savefig('BIT18_b31_bright.png')
...
proj=make_plot(lcc_values)
x,y=proj(longrid,latgrid)
CS=proj.ax.pcolormesh(x,y,ch32bright_grid,cmap=cmap,norm=the_norm)
CBar=proj.colorbar(CS, 'right', size='5%', pad='5%',extend='both')
CBar.set_label('12 micron brightness temp (K)')
proj.ax.set_title('12 micron brightness temp')
proj.ax.figure.canvas.draw()
fig.savefig('BIT18_b32_bright.png')

diffgrid = ch31bright_grid - ch32bright_grid
...
CBar=proj.colorbar(CS, 'right', size='5%', pad='5%',extend='both')
CBar.set_label('diff btwn 11 and 12 micron brightness temp (K)')
proj.ax.set_title('11 and 12 micron brightness temp difference')
proj.ax.figure.canvas.draw()
fig.savefig('BIT18_diffbright.png')
